...
public class EatGetStartedPage extends PublicHeaderMCD {

	public EatGetStartedPage(WebDriver driver) {
		super(driver);
		basedriver = driver;
		String DOMAIN_NAME = "eatGetStarted";
		String CLASS_NAME = "EatGetStartedPage";
		super.initPage(DOMAIN_NAME, CLASS_NAME);
		loadObjectMap();
		initializeHtmlObjects(this, this.objectMap);
	}

	protected WebObject eatGetStartedTitle;
	...
	private final static String EAT_GET_STARTED_BREADCRUMB = ".body4 a[href='/diet/members/eat/get-started']";
	private final static String ARTICLE_NAME = "Food energy density: Feel full on fewer calories";
	...
	public EatGetStartedPage checkEatGetStartedUrl() {
		...
		assertTrue(currentUrl.contains("/diet/members/eat/get-started"), "URL doesn't contain '/diet/members/eat/get-started'");
		return this;
	}

	public EatGetStartedPage checkEatGetStartedTitleDisplayed() {
		Logger.info("Check The Eat Get Started title is displayed");
		boolean isEatGetStartedTitleDisplayed = eatGetStartedTitle
				.waitUntilVisible()
				.isPresent();
		assertTrue(isEatGetStartedTitleDisplayed, "The Eat Get Started Title is not displayed");
		return this;
	}

	public EatGetStartedPage checkArticleSectionsOnEatGetStartedPage() {
		Logger.info("Check Photo displays with Article headline, a summary of the article content and the link to that article on Eat Get Started Page");
		basedriver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	...
	public EatGetStartedPage checkEatGetStartedBreadcrumb() {
		Logger.info("Check the breadcrumb");
		String breadcrumbs = breadcrumb
				.waitElementsReady()
				.getText();
		assertEquals(breadcrumbs, "HOMEEATGET STARTED", "The breadcrumb is not correct");
		return this;
	}

	public EatGetStartedPage openArticleFromEatGetStartedPage() {
		...
		for (int articleNumber = 0; articleNumber < 3; articleNumber++) {
			...
			if (articleContent.isElementPresent()) {
				...
				clickWithJs(EAT_GET_STARTED_BREADCRUMB);
			} else {
				clickWithJs(EAT_GET_STARTED_BREADCRUMB);
			}
		}
	...
	public EatGetStartedPage checkArticleHeaderAndSubTextOnArticleEatGetStartedPage() {
	...
	public EatGetStartedPage checkArticleImageOnArticleEatGetStartedPage() {
	...
	public EatGetStartedPage checkArticleContentOnArticleEatGetStartedPage() {
	...
	public EatGetStartedPage checkArticleBreadcrumbOnArticleEatGetStartedPage() {
	...
	public EatGetStartedPage openSlideShowFromEatGetStartedPage() {
	...
	public EatGetStartedPage checkSlideShowHeaderAndSubTextFromEatGetStartedPage() {
		Logger.info("Check the slide show page is loaded");
		basedriver.manage().timeouts().implicitlyWait(0, TimeUnit.SECONDS);
		List<WebElement> article = basedriver.findElements(By.cssSelector(ARTICLE_TITLE_CSS));
		for (int articleNumber = 0; articleNumber < article.size(); articleNumber++) {
	...
	public EatGetStartedPage checkSlideShowContentFromEatGetStartedPage() {
	...
	public EatGetStartedPage checkSlideShowBreadcrumbFromEatGetStartedPage() {
	...
	public EatGetStartedPage checkSlideShowThumbnailsFromEatGetStartedPage() {
	...
	public EatGetStartedPage checkSlideShowNavigationArrowsFromEatGetStartedPage() {
