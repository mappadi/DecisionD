...
public class EatSmartFoodChoicesPage extends PublicHeaderMCD {

	public EatSmartFoodChoicesPage(WebDriver driver) {
		super(driver);
		basedriver = driver;
		String DOMAIN_NAME = "smartFoodChoices";
		String CLASS_NAME = "EatSmartFoodChoicesPage";
	...
	private final static String SMART_FOOD_CHOICES_BREADCRUMB = ".column.breadcrumb a[href='/diet/members/eat/smart-food-choices']";
	private final static String[] ARTICLE_NAME = {"Make fruit fun: 5 delicious recipes", "7 dietary sources of energy"};
	...
	public EatSmartFoodChoicesPage checkSmartFoodChoicesUrl() {
		Logger.info("Check 'Smart Food Choices' page url");
		basedriver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		String currentUrl = basedriver.getCurrentUrl();
		assertTrue(currentUrl.contains("/diet/members/eat/smart-food-choices"), "URL doesn't contain '/diet/members/eat/smart-food-choices'");
		return this;
	}

	public EatSmartFoodChoicesPage checkArticleSectionsOnSmartFoodChoicesPage() {
		Logger.info("Check Photo displays with Article headline, a summary of the article content and the link to that article on Smart Food Choices Page");
		basedriver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	...
	public EatSmartFoodChoicesPage checkEatSmartFoodChoicesBreadcrumb() {
		Logger.info("Check the breadcrumb");
		String breadcrumbs = breadcrumb
				.waitElementsReady()
				.getText();
		assertEquals(breadcrumbs, "HOMEEATSMART FOOD CHOICES", "The breadcrumb is not correct");
		return this;
	}


	public EatSmartFoodChoicesPage openArticleFromSmartFoodChoicesPage() {
		...
		for (int articleNumber = 0; articleNumber < 3; articleNumber++) {
			...
			if (articleContent.isElementPresent()) {
				...
				clickWithJs(SMART_FOOD_CHOICES_BREADCRUMB);
			} else {
				clickWithJs(SMART_FOOD_CHOICES_BREADCRUMB);
			}
		}
	...
	public EatSmartFoodChoicesPage checkArticleHeaderAndSubTextOnArticleSmartFoodChoicesPage() {
	...
	public EatSmartFoodChoicesPage checkArticleImageOnArticleSmartFoodChoicesPage() {
	...
	public EatSmartFoodChoicesPage checkArticleContentOnArticleSmartFoodChoicesPage() {
	...
	public EatSmartFoodChoicesPage checkArticleBreadcrumbOnArticleSmartFoodChoicesPage() {
	...
	public EatSmartFoodChoicesPage openSlideShowFromSmartFoodChoicesPage() {
	...
	public EatSmartFoodChoicesPage checkSlideShowHeaderAndSubTextFromSmartFoodChoicesPage() {
	...
	public EatSmartFoodChoicesPage checkSlideShowContentFromSmartFoodChoicesPage() {
	...
	public EatSmartFoodChoicesPage checkSlideShowBreadcrumbFromSmartFoodChoicesPage() {
	...
	public EatSmartFoodChoicesPage checkSlideShowThumbnailsFromSmartFoodChoicesPage() {
	...
	public EatSmartFoodChoicesPage checkSlideShowNavigationArrowsFromSmartFoodChoicesPage() {
		...
		for (int slideShowNumber = 0; slideShowNumber < ARTICLE_NAME.length; slideShowNumber++) {
			...
			for (int articleNumber = 0; articleNumber < article.size(); articleNumber++) {
				...
				if (articleTitle.equals(ARTICLE_NAME[slideShowNumber])) {
					...
					for (int slidesNumber = 0; slidesNumber < slides.size(); slidesNumber++) {
						waitFor(1000);
