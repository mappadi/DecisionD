...
public class MotivateObstaclesPage extends PublicHeaderMCD {

	public MotivateObstaclesPage(WebDriver driver) {
		super(driver);
		basedriver = driver;
		String DOMAIN_NAME = "obstacles";
		String CLASS_NAME = "MotivateObstaclesPage";
	...
	private final static String OBSTACLES_BREADCRUMB = ".column.breadcrumb a[href='/diet/members/motivate/obstacles']";
	private final static String ARTICLE_NAME = "6 strategies to help control eating triggers";
	...
	public MotivateObstaclesPage checkObstaclesUrl() {
		Logger.info("Check 'Obstacles' page url");
		basedriver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		String currentUrl = basedriver.getCurrentUrl();
		assertTrue(currentUrl.contains("/diet/members/motivate/obstacles"), "URL doesn't contain '/diet/members/motivate/obstacles'");
		return this;
	}

	public MotivateObstaclesPage checkArticleSectionsOnObstaclesPage() {
		Logger.info("Check Photo displays with Article headline, a summary of the article content and the link to that article on Obstacles Page");
		basedriver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	...
	public MotivateObstaclesPage checkObstaclesBreadcrumb() {
		Logger.info("Check the breadcrumb");
		String breadcrumbs = breadcrumb
				.waitElementsReady()
				.getText();
		assertEquals(breadcrumbs, "HOMEMOTIVATEOBSTACLES", "The breadcrumb is not correct");
		return this;
	}

	public MotivateObstaclesPage openArticleFromObstaclesPage() {
		...
		for (int articleNumber = 0; articleNumber < 3; articleNumber++) {
			...
			if (articleContent.isElementPresent()) {
				...
				clickWithJs(OBSTACLES_BREADCRUMB);
			} else {
				clickWithJs(OBSTACLES_BREADCRUMB);
			}
		}
	...
	public MotivateObstaclesPage checkArticleHeaderAndSubTextOnArticleObstaclesPage() {
	...
	public MotivateObstaclesPage checkArticleImageOnArticleObstaclesPage() {
	...
	public MotivateObstaclesPage checkArticleContentOnArticleObstaclesPage() {
	...
	public MotivateObstaclesPage checkArticleBreadcrumbOnArticleObstaclesPage() {
	...
	public MotivateObstaclesPage openSlideShowFromObstaclesPage() {
	...
	public MotivateObstaclesPage checkSlideShowHeaderAndSubTextFromObstaclesPage() {
	...
	public MotivateObstaclesPage checkSlideShowContentFromObstaclesPage() {
		Logger.info("Check the slide show header and sub-text are displayed");
		basedriver.manage().timeouts().implicitlyWait(0, TimeUnit.SECONDS);
		List<WebElement> article = basedriver.findElements(By.cssSelector(ARTICLE_TITLE_CSS));
		for (int articleNumber = 0; articleNumber < article.size(); articleNumber++) {
	...
	public MotivateObstaclesPage checkSlideShowBreadcrumbFromObstaclesPage() {
	...
	public MotivateObstaclesPage checkSlideShowThumbnailsFromObstaclesPage() {
	...
	public MotivateObstaclesPage checkSlideShowNavigationArrowsFromObstaclesPage() {
