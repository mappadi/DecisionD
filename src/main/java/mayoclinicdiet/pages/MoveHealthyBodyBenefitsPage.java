...
public class MoveHealthyBodyBenefitsPage extends PublicHeaderMCD {

	public MoveHealthyBodyBenefitsPage(WebDriver driver) {
		super(driver);
		basedriver = driver;
		String DOMAIN_NAME = "healthyBodyBenefits";
		String CLASS_NAME = "MoveHealthyBodyBenefitsPage";
	...
	private final static String HEALTHY_BODY_BENEFITS_BREADCRUMB = ".column.breadcrumb a[href='/diet/members/move/healthy-body-benefits']";
	private final static String ARTICLE_NAME = "Get moving: 7 key benefits of regular exercise";
	...
	public MoveHealthyBodyBenefitsPage checkHealthyBodyBenefitsUrl() {
		Logger.info("Check 'Healthy Body Benefits' page url");
		basedriver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		String currentUrl = basedriver.getCurrentUrl();
		assertTrue(currentUrl.contains("/diet/members/move/healthy-body-benefits"), "URL doesn't contain '/diet/members/move/healthy-body-benefits'");
		return this;
	}

	public MoveHealthyBodyBenefitsPage checkArticleSectionsOnHealthyBodyBenefitsPage() {
		Logger.info("Check Photo displays with Article headline, a summary of the article content and the link to that article on Healthy Body Benefits Page");
		basedriver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	...
	public MoveHealthyBodyBenefitsPage checkMoveHealthyBodyBenefitsBreadcrumb() {
		Logger.info("Check the breadcrumb");
		String breadcrumbs = breadcrumb
				.waitElementsReady()
				.getText();
		assertEquals(breadcrumbs, "HOMEMOVEHEALTHY BODY BENEFITS", "The breadcrumb is not correct");
		return this;
	}

	public MoveHealthyBodyBenefitsPage openArticleFromHealthyBodyBenefitsPage() {
		...
		for (int articleNumber = 0; articleNumber < 3; articleNumber++) {
			...
			if (articleContent.isElementPresent()) {
				...
				clickWithJs(HEALTHY_BODY_BENEFITS_BREADCRUMB);
			} else {
				clickWithJs(HEALTHY_BODY_BENEFITS_BREADCRUMB);
			}
		}
	...
	public MoveHealthyBodyBenefitsPage checkArticleHeaderAndSubTextOnArticleHealthyBodyBenefitsPage() {
	...
	public MoveHealthyBodyBenefitsPage checkArticleImageOnArticleHealthyBodyBenefitsPage() {
	...
	public MoveHealthyBodyBenefitsPage checkArticleContentOnArticleHealthyBodyBenefitsPage() {
	...
	public MoveHealthyBodyBenefitsPage checkArticleBreadcrumbOnArticleHealthyBodyBenefitsPage() {
	...
	public MoveHealthyBodyBenefitsPage openSlideShowFromHealthyBodyBenefitsPage() {
	...
	public MoveHealthyBodyBenefitsPage checkSlideShowHeaderAndSubTextFromHealthyBodyBenefitsPage() {
	...
	public MoveHealthyBodyBenefitsPage checkSlideShowContentFromHealthyBodyBenefitsPage() {
	...
	public MoveHealthyBodyBenefitsPage checkSlideShowBreadcrumbFromHealthyBodyBenefitsPage() {
	...
	public MoveHealthyBodyBenefitsPage checkSlideShowThumbnailsFromHealthyBodyBenefitsPage() {
	...
	public MoveHealthyBodyBenefitsPage checkSlideShowNavigationArrowsFromHealthyBodyBenefitsPage() {
