...
public class EatMealsMadeEasyPage extends PublicHeaderMCD {

	public EatMealsMadeEasyPage(WebDriver driver) {
		super(driver);
		basedriver = driver;
		String DOMAIN_NAME = "mealsMadeEasy";
		String CLASS_NAME = "EatMealsMadeEasyPage";
	...
	private final static String MEALS_MADE_EASY_BREADCRUMB = ".column.breadcrumb a[href='/diet/members/eat/meals-made-easy']";
	private final static String ARTICLE_NAME = "Eat your veggies: 5 tasty meatless meals";
	...
	public EatMealsMadeEasyPage checkMealsMadeEasyUrl() {
		Logger.info("Check 'Meals Made Easy' page url");
		basedriver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
		String currentUrl = basedriver.getCurrentUrl();
		assertTrue(currentUrl.contains("/diet/members/eat/meals-made-easy"), "URL doesn't contain '/diet/members/eat/meals-made-easy'");
		return this;
	}

	public EatMealsMadeEasyPage checkArticleSectionsOnMealsMadeEasyPage() {
		Logger.info("Check Photo displays with Article headline, a summary of the article content and the link to that article on Meals Made Easy Page");
		basedriver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
	...
	public EatMealsMadeEasyPage checkEatMealsMadeEasyBreadcrumb() {
		Logger.info("Check the breadcrumb");
		String breadcrumbs = breadcrumb
				.waitElementsReady()
				.getText();
		assertEquals(breadcrumbs, "HOMEEATMEALS MADE EASY", "The breadcrumb is not correct");
		return this;
	}

	public EatMealsMadeEasyPage openArticleFromMealsMadeEasyPage() {
		...
		for (int articleNumber = 0; articleNumber < 3; articleNumber++) {
			...
			if (articleContent.isElementPresent()) {
				...
				clickWithJs(MEALS_MADE_EASY_BREADCRUMB);
			} else {
				clickWithJs(MEALS_MADE_EASY_BREADCRUMB);
			}
		}
	...
	public EatMealsMadeEasyPage checkArticleHeaderAndSubTextOnArticleMealsMadeEasyPage() {
	...
	public EatMealsMadeEasyPage checkArticleImageOnArticleMealsMadeEasyPage() {
	...
	public EatMealsMadeEasyPage checkArticleContentOnArticleMealsMadeEasyPage() {
	...
	public EatMealsMadeEasyPage checkArticleBreadcrumbOnArticleMealsMadeEasyPage() {
	...
	public EatMealsMadeEasyPage openSlideShowFromMealsMadeEasyPage() {
	...
	public EatMealsMadeEasyPage checkSlideShowHeaderAndSubTextFromMealsMadeEasyPage() {
	...
	public EatMealsMadeEasyPage checkSlideShowContentFromMealsMadeEasyPage() {
	...
	public EatMealsMadeEasyPage checkSlideShowBreadcrumbFromMealsMadeEasyPage() {
	...
	public EatMealsMadeEasyPage checkSlideShowThumbnailsFromMealsMadeEasyPage() {
	...
	public EatMealsMadeEasyPage checkSlideShowNavigationArrowsFromMealsMadeEasyPage() {
